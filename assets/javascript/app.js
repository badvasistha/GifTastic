$(document).ready(function() {
    ...
    var topics = [];
      ...
      //Create div with respective still and animate image sources with "data-state", "data-still" and "data-animate" attributes
        ...
        var queryURL = "https://api.giphy.com/v1/gifs/search?q=" + x + "&api_key=bizSXWapvvd81SeBYlL80YTAMYP8t7TU";
      ...
      //Click event on button with id of "show" executes renderGifs function
      $(document).on("click", "#show", renderGifs);
